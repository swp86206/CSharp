...
namespace _0923_array
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
           ...
           // int[] numbers = new int[6]; //配置有6個整數的地方(空間)
            //numbers[1] = 49;// 跳一格的位置(編號1號的位置)
            numbers[5] = 49;
            int x = numbers[0]; //取出編號5的數
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            /*int[] numbers = new int[6] { 10, 23, 1, 9, 25, 33 };*/ //new int[6] 要寫剛剛好的數字
        ...
        {
            Hashtable dataBag = new Hashtable(); //Hashtable:一組資料裡面都是文字
